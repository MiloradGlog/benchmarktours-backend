...
import discussionActivityRoutes from './api/discussions/discussion-activity.routes';
...
import adminPasswordResetRoutes from './api/admin/passwordReset.routes';
...
app.use('/api/discussion-activities', discussionActivityRoutes);
